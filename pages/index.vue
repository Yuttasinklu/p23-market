      ...
      <div class="dashboard-hero__side">
        <div class="dashboard-hero__coin-panel">
          <div class="dashboard-hero__coin-wrap">
            <img src="/images/dim-coin2.png" alt="coin" class="dashboard-hero__coin" />
          ...
          <div class="dashboard-hero__market-total">
            ...
            <strong class="value value--coin">
              {{ dashboardTotalCoin }}<img src="/images/dim-coin2.png" alt="coin" class="coin-unit coin-unit--sm" />
            </strong>
          </div>
        </div>
    ...
    <section class="card dashboard-vs-stats">
      <article class="dashboard-vs-stats__side is-winner">
        ...
        <p class="dashboard-vs-stats__meta">
          {{ t("common.net") }} {{ dashboardTopWinner?.netWorth || 0 }}<img src="/images/dim-coin2.png" alt="coin" class="coin-unit coin-unit--sm" /> • {{ t("dashboard.mvp") }}
        </p>
      </article>
      <article class="dashboard-vs-stats__side is-loser">
        ...
        <p class="dashboard-vs-stats__meta">
          {{ t("common.net") }} {{ dashboardTopLoser?.netWorth || 0 }}<img src="/images/dim-coin2.png" alt="coin" class="coin-unit coin-unit--sm" /> • {{ t("dashboard.comeback") }}
        </p>
      </article>
    </section>
        ...
        >
          <div class="dashboard-feed__top">
            ...
            <span class="dashboard-feed__amount">
              {{ tx.amount }}<img src="/images/dim-coin2.png" alt="coin" class="coin-unit coin-unit--sm" />
            </span>
          </div>
